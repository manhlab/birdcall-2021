...
def get_dict_value(input_dir):
    dict_val = {}
    dict_val = fill_range(
        "a", "b", input_dir / "birdsong-resampled-train-audio-00", dict_val
    )
    dict_val = fill_range(
        "c", "f", input_dir / "birdsong-resampled-train-audio-01", dict_val
    )
    dict_val = fill_range(
        "g", "m", input_dir / "birdsong-resampled-train-audio-02", dict_val
    )
    dict_val = fill_range(
        "n", "r", input_dir / "birdsong-resampled-train-audio-03", dict_val
    )
    dict_val = fill_range(
        "s", "y", input_dir / "birdsong-resampled-train-audio-04", dict_val
    )
    return dict_val
